...
//            e.printStackTrace();
    ...
    public static byte[] aesEncryptToBytes(String content, String encryptKey) throws Exception {
        ...
        byte[] paddingConent = Arrays.copyOf(contentBytes, 16 * (int)Math.ceil(contentBytes.length /16.0));
        return cipher.doFinal(paddingConent);
    }
