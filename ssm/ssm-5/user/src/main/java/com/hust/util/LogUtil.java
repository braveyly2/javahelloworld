...
public class LogUtil {
    ...
    private static final String FQCN = com.hust.accountcommon.util.LogUtil.class.getName();
    private static Method innerMethod;
    private static int modelNameLen;

    static {
        innerLogger = LoggerFactory.getLogger(com.hust.accountcommon.util.LogUtil.class);
        try {
