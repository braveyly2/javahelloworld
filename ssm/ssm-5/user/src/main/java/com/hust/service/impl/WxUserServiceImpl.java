...
public class WxUserServiceImpl implements WxUserService {
    ...
    public LoginResultDto wxLogin(String code){
        ...
        try {
            ...
            //1.判断微信号是否能匹配上账号
            User user = userMapper.selectByWxId(weixinUserInfo.getUnionid());
            //1.1 未匹配上
    ...
    public LoginResultDto wxBindAccount(String code, String loginName, String dynCode){
        ...
        //2.判断绑定的账户是否输入正确的验证码
        DynamicCodeRedisDto dynamicCodeRedisDto = (DynamicCodeRedisDto)jedisUtils.get(UserConstant.REDIS_LOGIN_DYNAMIC_CODE+loginName);
        ...
        User vxUser = userMapper.selectByPrimaryKey(Integer.parseInt(userId));
        if(PublicUtil.isEmpty(user)){
    ...
    public int accountBindWx(String code, long userId){
        ...
        User vxUser = userMapper.selectByWxId(weixinUserInfo.getUnionid());
