...
public class PublicUtil {
    ...
    public static BasicInput getDefaultBasicInput(){
        return new BasicInput("1.0", String.valueOf(getRequestId()), getUtcTimestampOfSecond(), null, getNonce(), null, null);
    }

    public static BasicOutput getDefaultBasicOutputByInput(BasicInput basicInput){
        return new BasicOutput(basicInput.getId(), getUtcTimestampOfSecond(), ErrorCodeEnum.TD200.code(), ErrorCodeEnum.TD200.msg(),null);
    }
